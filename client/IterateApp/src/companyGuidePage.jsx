...
.cg-back{font-family:var(--font-body);font-size:13.5px;color:var(--gray2);background:none;border:none;
...
.cg-intro{font-family:var(--font-body);font-size:15px;color:var(--gray1);font-style:italic;margin-top:8px;
...
.cg-stage-num{font-family:var(--font-body);font-size:13px;font-weight:600;color:var(--paper);
  background:var(--ink);width:22px;height:22px;border-radius:50%;flex-shrink:0;
  display:flex;align-items:center;justify-content:center}
.cg-stage-text{font-family:var(--font-body);font-size:15px;color:var(--gray1)}
...
.cg-chip{font-family:var(--font-body);font-size:12px;padding:1px 10px;background:var(--paper3);
...
.cg-qcard-text{font-family:var(--font-body);font-size:17px;font-weight:600;line-height:1.35;margin-bottom:6px}
.cg-qcard-details{font-family:var(--font-body);font-size:14px;color:var(--gray1);font-style:italic;margin-bottom:8px;
  padding-left:8px;border-left:2px solid var(--gray4)}
.cg-qcard-code{font-family:'Courier New',monospace;font-size:13px;background:var(--ink);color:var(--paper);
  padding:0.75rem 0.9rem;border-radius:2px;overflow-x:auto;white-space:pre}

.cg-status{font-family:var(--font-body);font-size:16px;color:var(--gray2);font-style:italic;
